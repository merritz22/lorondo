...
<template>
    <footer class="bg-cyan-100 mt-5 border-t-2 border-cyan-200">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://lorondoservices.com/" class="flex items-center">
                  <img src='@/assets/images/logo.jpg' class="h-8 w-8 mr-3 rounded-full" alt="FlowBite Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap">Lorondo Services</span>
              </a>
          </div>
          <div class="flex justify-center">
              ...
              <div>
                  ...
                  <ul class="text-black dark:text-indigo-900 font-medium">
                        ...
                        <li class="mb-4">
                          <a href="https://wa.me/752640953" class="hover:underline">
                            +40 752 640 953
                          </a>
                      </li>
                      <li>
                          <a href="contact@lorondoservices.com" class="hover:underline">
                            contact@lorondoservices.com
                          </a>
                      </li>
                  </ul>
              </div>
